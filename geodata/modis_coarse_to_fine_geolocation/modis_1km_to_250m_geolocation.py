...
def get_1km_pix_to_plot ( itk_250m, isc_250m, lat_1km, lon_1km ) :
    ...
    v_label = [ "[%d,%d]"%(v_itk_1km[i],v_isc_1km[i]) for i in range ( npix ) ]
...
def main():
    ...
    if __DEBUG__ :
        ...
        for itk_250m in range ( itk_250m_min, itk_250m_max + 1 ) :
            for isc_250m in range ( isc_250m_min, isc_250m_max + 1 ) :
